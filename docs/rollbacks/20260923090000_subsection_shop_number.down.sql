-- Rollback for 20260923090000_subsection_shop_number: restore the public review RPC exactly as it
-- was (pg_get_functiondef of the live function before the change), then drop the column.
...
ALTER TABLE public.subsections DROP COLUMN IF EXISTS shop_number;
