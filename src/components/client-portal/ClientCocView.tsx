    ...
    try {
      ...
      const model = buildCocReportModel({
        ...
        subsections: (data?.subsections ?? []).map((s) => ({
          ...
          is_coc_required: s.is_coc_required,
        })),
        certificates: (certRes.data ?? []).map((c: any) => ({
          ...
          coc_document_id: c.coc_document_id,
          eval_document_id: c.eval_document_id,
          shop_no_raw: c.shop_no_raw,
          doc_type: c.doc_type,
          clause_9_2: c.clause_9_2,
        ...
        schedule: (schedRes.data ?? []).map((r: any) => ({
          ...
          shop_no_raw: r.shop_no_raw,
          initial_cert_nos: r.initial_cert_nos,
          supplementary_cert_nos: r.supplementary_cert_nos,
          trading_name: r.trading_name,
          coc_required: r.coc_required,
