...
export function COCPreviewDialog({ open, onClose, document, validation }: COCPreviewDialogProps) {
  ...
  const getClauseLocation = useCallback((clause: string, section?: string): { location: string; page: number } => {
    ...
    const clauseLocations: Record<string, { location: string; page: number }> = {
      // SANS clause references → Section 4 item numbers (standard SA COC form)
      '8.4': { location: 'Section 4, Item 4.1 — Earth Continuity', page: 2 },
      '8.5': { location: 'Section 4, Item 4.4 — Earth Loop Impedance (Zs)', page: 2 },
      '8.6': { location: 'Section 4, Item 4.2 — Insulation Resistance', page: 2 },
      '8.7': { location: 'Section 4, Item 4.6 — Polarity', page: 2 },
      '8.8': { location: 'Section 4, Item 4.3 — RCD / Earth Leakage', page: 2 },
      '8.3': { location: 'Section 4, Item 4.5 — PSCC / Overcurrent Protection', page: 2 },
      '6.1': { location: 'Section 1 — Installation Details', page: 1 },
      '6.2': { location: 'Section 2 — Circuit Schedule', page: 1 },
      '7.1': { location: 'Section 3 — Inspection Checks', page: 1 },
      '7.2': { location: 'Section 3 — Conductor Sizing', page: 1 },
      '5.1': { location: 'Section 1 — Certificate Details', page: 1 },
      '5.2': { location: 'Section 1 — Installer Registration', page: 1 },
      '10': { location: 'Section 4 — Voltage Drop', page: 2 },
      '22': { location: 'Section 5 — Documentation & Certification', page: 1 },
      '26': { location: 'Section 4 — Generator Installation', page: 2 },
      '27': { location: 'Section 4 — Inverter/Solar Systems', page: 2 },
      '28': { location: 'Section 4 — Surge Protection Devices', page: 2 },
      // Check ID mappings (from deterministic engine) → Section 4 item numbers
      'EARTH-001': { location: 'Section 4, Item 4.1 — Earth Continuity (Clause 8.4)', page: 2 },
      'LOOP-001': { location: 'Section 4, Item 4.4 — Earth Loop Impedance Zs (Clause 8.5)', page: 2 },
      'INSUL-001': { location: 'Section 4, Item 4.2 — Insulation Resistance (Clause 8.6)', page: 2 },
      'POL-001': { location: 'Section 4, Item 4.6 — Polarity (Clause 8.7)', page: 2 },
      'RCD-001': { location: 'Section 4, Item 4.3 — RCD / Earth Leakage (Clause 8.8)', page: 2 },
      'OCP-001': { location: 'Section 4, Item 4.5 — Overcurrent Protection (Clause 8.3)', page: 2 },
      'PSCC-001': { location: 'Section 4, Item 4.5 — Prospective Short-Circuit Current (Clause 8.3)', page: 2 },
      'COND-001': { location: 'Section 3 — Conductor Sizing (Clause 7.2)', page: 1 },
      'DOC-001': { location: 'Section 5 — Documentation (Clause 22)', page: 1 },
      'SIG-001': { location: 'Section 5 — Signature Block', page: 1 },
      'COC-TYPE-001': { location: 'Section 1 — Certificate Type Checkboxes', page: 1 },
      'COC-INIT-001': { location: 'Section 1 — Certificate Hierarchy (Initial COC)', page: 1 },
      'COC-SUPP-001': { location: 'Section 1 — Certificate Hierarchy (Supplementary Reference)', page: 1 },
      'COC-TEMP-001': { location: 'Section 1 — Certificate Hierarchy (Temporary Reference)', page: 1 },
      'COC-VALID-001': { location: 'Section 1 — Certificate Hierarchy Compliance', page: 1 },
      'CERT-DATE-001': { location: 'Section 1 — Certificate Date', page: 1 },
      'CERT-EXPIRY-001': { location: 'Section 1 — Certificate Validity Period', page: 1 },
      'CERT-INCOMPLETE-001': { location: 'Section 1 — Certificate Completeness', page: 1 },
      'SPD-001': { location: 'Section 4 — Surge Protection Devices (Clause 28)', page: 2 },
      'GEN-001': { location: 'Section 4 — Generator Installation (Clause 26)', page: 2 },
      'INV-001': { location: 'Section 4 — Inverter/Solar Systems (Clause 27)', page: 2 },
      'VD-001': { location: 'Section 4 — Voltage Drop (Clause 10)', page: 2 },
      'Hierarchy': { location: 'Section 1 — Certificate Hierarchy', page: 1 },
    };
