...
export function COCPreviewDialog({ open, onClose, document, validation }: COCPreviewDialogProps) {
  ...
  const getClauseLocation = useCallback((clause: string, section?: string): { location: string; page: number } => {
    ...
    const clauseLocations: Record<string, { location: string; page: number }> = {
      ...
      '8.7': { location: 'Test Results - Polarity & Continuity', page: 2 },
      '8.8': { location: 'Test Results - RCD Testing', page: 2 },
      '8.3': { location: 'Test Results - Overcurrent Protection', page: 2 },
      '6.1': { location: 'Installation Details', page: 1 },
      '6.2': { location: 'Circuit Schedule', page: 1 },
      '7.1': { location: 'Inspection Checks', page: 1 },
      '7.2': { location: 'Conductor Sizing', page: 1 },
      '5.1': { location: 'Certificate Details', page: 1 },
      '5.2': { location: 'Installer Registration', page: 1 },
      '10': { location: 'Voltage Drop', page: 2 },
      '22': { location: 'Documentation & Certification', page: 1 },
      '26': { location: 'Generator Installation', page: 2 },
      '27': { location: 'Inverter/Solar Systems', page: 2 },
      '28': { location: 'Surge Protection Devices', page: 2 },
      // Check ID mappings (from deterministic engine)
      'EARTH-001': { location: 'Test Results - Earth Resistance (Clause 8.4)', page: 2 },
      'LOOP-001': { location: 'Test Results - Earth Loop Impedance (Clause 8.5)', page: 2 },
      'INSUL-001': { location: 'Test Results - Insulation Resistance (Clause 8.6)', page: 2 },
      'POL-001': { location: 'Test Results - Polarity & Continuity (Clause 8.7)', page: 2 },
      'RCD-001': { location: 'Test Results - RCD Testing (Clause 8.8)', page: 2 },
      'OCP-001': { location: 'Test Results - Overcurrent Protection (Clause 8.3)', page: 2 },
      'PSCC-001': { location: 'Test Results - Prospective Short-Circuit Current (Clause 8.3)', page: 2 },
      'COND-001': { location: 'Circuit Schedule - Conductor Sizing (Clause 7.2)', page: 1 },
      'DOC-001': { location: 'Certificate Details - Documentation (Clause 22)', page: 1 },
      'SIG-001': { location: 'Signature Block', page: 1 },
      'COC-TYPE-001': { location: 'Certificate Type Checkboxes', page: 1 },
      'COC-INIT-001': { location: 'Certificate Hierarchy - Initial COC', page: 1 },
      'COC-SUPP-001': { location: 'Certificate Hierarchy - Supplementary Reference', page: 1 },
      'COC-TEMP-001': { location: 'Certificate Hierarchy - Temporary Reference', page: 1 },
      'COC-VALID-001': { location: 'Certificate Hierarchy Compliance', page: 1 },
      'CERT-DATE-001': { location: 'Certificate Date', page: 1 },
      'CERT-EXPIRY-001': { location: 'Certificate Validity Period', page: 1 },
      'CERT-INCOMPLETE-001': { location: 'Certificate Completeness', page: 1 },
      'SPD-001': { location: 'Surge Protection Devices (Clause 28)', page: 2 },
      'GEN-001': { location: 'Generator Installation (Clause 26)', page: 2 },
      'INV-001': { location: 'Inverter/Solar Systems (Clause 27)', page: 2 },
      'VD-001': { location: 'Voltage Drop (Clause 10)', page: 2 },
      'Hierarchy': { location: 'Certificate Hierarchy', page: 1 },
    };
