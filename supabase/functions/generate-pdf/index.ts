...
// UNIFIED 3-COLUMN GRID: 180x140px with object-fit: cover (fills container, crops bottom)
  ...
  // object-fit: cover fills container, object-position: center top preserves top content
  return `
        ...
        <tr>
          ${row.map(item => `
            <td style="padding: 6px; vertical-align: top; text-align: center; width: 33.33%;">
              ...
              <div style="display: inline-block; border: 1px solid #e5e7eb; border-radius: 4px; overflow: hidden;">
                <img src="${item.photo}" style="width: ${imageWidthPx}px; height: ${imageHeightPx}px; object-fit: cover; object-position: center top; display: block;" />
              </div>
            </td>
          `).join('')}
        </tr>
